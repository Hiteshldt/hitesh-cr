...
function showPage(page) {
    // List of all pages
    const pages = ['Dashboard-Page', 'Profile-Page', 'Aboutus-Page', 'Logout-Page'];
    // Hide all pages
    pages.forEach(p => {
  ...
  const logoutItem = document.querySelector('.logoutbtn');
  ...
  logoutItem.addEventListener('click', () => showPage('Logout-Page'));
